...
export default class ScrollTopView extends React.Component {
  ...
  public render() {
    return (
      <div className="nex-scroll-top-btn" onClick={this.handleScrollTopBtnClick.bind(this)}>
        👆
      </div>
    );
  }
  ...
  protected handleScrollTopBtnClick() {
    try {
      if (!this.notionEditorContainer) {
        this.notionEditorContainer = utils.queryElement(NOTION_PAGE_SCROLLER_CONTAINER) as HTMLElement;
      }
